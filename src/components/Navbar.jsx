        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900 w-full fixed top-0 left-0 z-20">
            <div class=" flex flex-wrap items-center justify-between p-4">
                ...
                <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse gap-4">
                    <ThemeSwitcher />
                    <button type="button" class="w-12 h-12 flex justify-center items-center text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
